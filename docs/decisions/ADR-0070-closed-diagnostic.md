...
**Supersedes:** —
**Related:** [ADR-0012](./ADR-0012-required-label-set.md) (4-cat invariant being protected), [ADR-0015](./ADR-0015-atomic-agent-handoff.md), [ADR-0027](./ADR-0027-deploy-automation.md) §Threat model (SHA-pin), [ADR-0043 §8 platform constraints](./ADR-0043-multi-reviewer-wake-doctrine.md), [ADR-0044](./ADR-0044-red-first-tdd.md) (RED-first TDD), [ADR-0045](./ADR-0045-9-lens-pre-publish.md) (9-Lens), [ADR-0049](./ADR-0049-d-test-framework.md) (d-test ≥5 TCs baseline), [ADR-0055 §1](./ADR-0055-cadence-rule-atomic-doctrine.md) (Cadence Rule 1 atomic), `docs/designs/TD-067b-design.md` (PR #928 squash @ c24e28e — canonical design contract)
...
| (j) Auto-gen file refs + live-state verification | No auto-gen files in scope. `label-check.yml` and `docs/decisions/INDEX.md` are hand-maintained (confirmed by `grep .gitignore` + `git log --diff-filter=A`). Live-state verification: `gh api repos/atilcan65/AtilCalculator/contents/.github/workflows/label-check.yml?ref=main` returns 200 post-merge. | live-state pre-PR grep + post-PR gh api check |
